...
DATAPATH='/data/cjx/ww/ManipArena_sim/processed_data/meta/sim_all_norm.pkl'
ACTION_TOKENIZER_PATH="/data/cjx/ww/structvla/pretrain/fast"
...
torchrun \
    ...
    train/train_moe.py \
    --model_name_or_path /data/cjx/ww/structvla/logs/ManipArena_sim/merged \
    --model_config_path /data/cjx/ww/structvla/configs/moe_fast_video.json \
    ...
    --report_to "wandb" \
    --run_name ${EXP_NAME} \
    > /data/cjx/ww/structvla/libero.log 2>&1
