...
EXP_NAME="SIM_singleview_1000step_prenorm_160140_final"
...
torchrun \
    ...
    train/train_moe.py \
    --model_name_or_path /remote-home/linweihao/structvla/logs/ManipArena_sim_gripper_3view_160140/merged \
    ...
    --report_to "wandb" \
    --run_name ${EXP_NAME} \
    > /remote-home/linweihao/structvla/${EXP_NAME}.log 2>&1
