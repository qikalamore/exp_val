...
DATAPATH='/data/cjx/ww/put_ring_onto_rod/processed_data/meta/put_ring_onto_rod_norm.pkl'
...
torchrun \
    ...
    --model_name_or_path /data/cjx/ww/WORLD_MODEL_POSTTRAIN \
    --model_config_path /data/cjx/ww/structvla/configs/moe_fast_video_pretrain.json \
