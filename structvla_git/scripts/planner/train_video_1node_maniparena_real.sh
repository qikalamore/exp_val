...
DATAPATH='/remote-home/linweihao/maniparena_dataset_real/processed_data/meta/real_all_dualarm_norm.pkl'
ACTION_TOKENIZER_PATH="/remote-home/linweihao/structvla/pretrain/fast"
EXP_NAME="ManipArena_real_planner_5000steps"
...
export WANDB_PROJECT="ManipArena_real_planner_5000steps"
...
torchrun \
    ...
    --run_name ${EXP_NAME} \
    --planner True \
    --keystep_path "/remote-home/linweihao/maniparena_dataset_real/processed_data/structout_testset/triplets_manifest.csv" \
    ...
    > /remote-home/linweihao/structvla/ManipArena_real_planner_5000steps.log 2>&1
