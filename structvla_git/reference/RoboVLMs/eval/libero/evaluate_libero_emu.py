...
import time
import sys
sys.path.append("/data/cjx/ww/structvla/reference/RoboVLMs")
...
sys.path.append("/data/cjx/ww/structvla/reference/RoboVLMs/LIBERO")
...
def parser_args():
    ...
    parser.add_argument("--vq_hub", type=str, default="/data/cjx/ww/Emu3_Base")
    parser.add_argument("--vision_hub", type=str, default="/data/cjx/ww/vq_hub")
    parser.add_argument(
        "--task_suite_name",
        type=str,
        choices=[
