...
from datasets_class import Emu3WorldModelDataset,Emu3RealRobotDataset,Emu3CoTDataset,Emu3PlannerDataset,Emu3PlannerRealRobotDataset
...
def get_dataset(data_args, tokenizer):
    ...
    if data_args.post_training:
        if getattr(data_args, "planner", False):
            if data_args.real_robot:
                return Emu3PlannerRealRobotDataset(data_args, tokenizer=tokenizer)
