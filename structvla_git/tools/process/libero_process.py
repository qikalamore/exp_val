...
sub_dataname = 'libero_goal_no_noops' # options: libero_goal_no_noops, libero_object_no_noops, libero_spatial_no_noops
dataset_dirs = f"/data/cjx/ww/libero_dataset/{sub_dataname}/1.0.0"
...
base_output_dir = "/data/cjx/ww/libero_dataset/processed_data/libero_all"
