...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="/data/cjx/ww/libero_dataset/processed_data", help="Root path to dataset.")
    parser.add_argument("--output_path", type=str, default="/data/cjx/ww/libero_dataset/processed_data/meta", help="Path to save normalized data.")
