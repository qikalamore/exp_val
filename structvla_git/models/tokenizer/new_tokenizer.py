...
data_config = {
    ...
    'maniparena': {
        ...
        'interval': 1,
        'SIZE': (160, 140),
        'VIDEO_ROOT': '/remote-home/linweihao/maniparena_dataset_sim/processed_data/sim_all',
        'VIDEO_CODES_SAVE': '/remote-home/linweihao/maniparena_dataset_sim/processed_data/maniparena_dualarm_codes_160_140',
        'VIDEO_RECON_SAVE': '/remote-home/linweihao/maniparena_dataset_sim/processed_data/maniparena_dualarm_recon_160_140',
    },
    'bridge_orig': {
        'min_pixels': 128 * 128,
        'interval': 1,
...
if __name__ == "__main__":
    ...
    MODEL_HUB = "/remote-home/linweihao/Emu3-VisionTokenizer"
    path = "/remote-home/linweihao/Emu3-VisionTokenizer"

    # choose the dataset to process
    process_data = 'maniparena'

    # current supported datasets
    simulator_list = ["Calvin", "Calvin_partial", "libero", "maniparena", 'libero_long', 'maniskill']
