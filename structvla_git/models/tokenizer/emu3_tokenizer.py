...
data_config = {
    ...
    'libero': {
        ...
        'interval': 1,
        'SIZE': (200, 200),
        'VIDEO_ROOT': '/data/cjx/ww/libero_dataset/processed_data/libero_all',
        'VIDEO_CODES_SAVE': '/data/cjx/ww/libero_dataset/processed_data/libero_all_codes_200', #200x200分辨率
        'VIDEO_RECON_SAVE': '/data/cjx/ww/libero_dataset/processed_data/libero_recon_256'
    },
    'bridge_orig': {
        'min_pixels': 128 * 128,
        'interval': 1,
...
if __name__ == "__main__":
    ...
    path = "/data/cjx/ww/Emu3-VisionTokenizer"
